                    ...
                    <tr>
                        <td align="center">
                            ...
                            <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                               ...
                               <!-- DESCOMENTAR PARA INSERTAR LOGO  <tr>
                                        ...
                                        <table width="360 " border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"
                                            ...
                                            <tr>
                                                <td width="120" align="center" style="font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                                    <a href="http://www.google.com" target="_blank" style="color: #312c32; text-decoration: none;">Quienes Somos?</a>
                                                </td>
                                                <td width="120" align="center" style="font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                                    <a href="http://www.google.com" target="_blank" style="color: #312c32; text-decoration: none;">Nuestros Servicios</a>
                                                </td>
                                                <td width="120" align="center" style="font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                                    <a href="http://www.google.com" target="_blank" style="color: #312c32; text-decoration: none;">Ayuda</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                    ...
                    <tr>
                        <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;"
                            ...
                            <div style="line-height: 35px">
                                ...
                                Creaci&oacuten de Cuenta - Tu Tiempo Libro <span style="color: #5caad2;">UPC</span>
                            ...
                            <table border="0" width="590" align="center" cellpadding="0" cellspacing="0" class="container590">
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        Hola ${persona.nombres }, ud se ha registrado en nuestro sistema. Estos son los datos de acceso a nuestra plataforma.
                                        ...
                                        <p style="line-height: 24px; margin-bottom:20px;">
                                            Password: <strong>${usuario.password }</strong>
                                        </p>
                                            ...
                                            <tr>
                                                <td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">
                                                    ...
                                                    <div style="line-height: 22px;">
                                                        <a href="#"  target="_blank" style="color: #ffffff; text-decoration: none;">Creaci�n Cuenta</a>
                                                    </div>
                                                </td>
                                            </tr>
                                ...
                                <tr>
                                    <td>
                                        <table border="0" width="300" align="left" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"
                                            ...
                                            <tr>
                                                <!-- logo -->
                                               <!-- DESCOMENTAR PARA INSERTAR LOGO <td align="left">
                                            ...
                                            <tr>
                                                <td align="left" style="color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;"
                                                    ...
                                                    <div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
                                                        ...
                                                        Email Admistrador: <br/> <a href="mailto:" style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">manuel.rios.alvarez@gmail.com</a>
